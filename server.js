...
admin.initializeApp({
  credential: admin.credential.cert({
    ...
    token_uri: String(process.env.SOCKET_TOKEN_URI),
    auth_provider_x509_cert_url: String(process.env.SOCKET_AUTH_PROVIDER_X509_CERT_URL),
    client_x509_cert_url: String(process.env.SOCKET_CLIENT_X509_CERT_URL),
  })
});
